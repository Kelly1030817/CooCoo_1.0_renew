...
describe('quantity and purchase recommendations',()=>{
 ...
 test('fee estimate includes the announced 2027 price change and conservative exchange rate',()=>{expect(usageCost(20000,10000,catalogRate(now))).toBeCloseTo(1.8375);expect(usageCost(20000,10000,catalogRate(new Date('2027-01-01')))).toBeCloseTo(3.675);});
