...
describe('quantity and purchase recommendations',()=>{
 ...
 test('catalog rejects newly generated steps without dual guidance',()=>{const incomplete=structuredClone(brandSafeRecipes[0]);delete incomplete.steps[0].compactInstruction;expect(inspectRecipe(incomplete,[]).reasons).toContain('STEP_INVALID');});
