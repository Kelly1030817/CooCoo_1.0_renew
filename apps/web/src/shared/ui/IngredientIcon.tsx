...
export function IngredientIcon({ name, className = "w-5 h-5", size }: IngredientIconProps) {
  ...
  if (/蛋/.test(n) && !/皮蛋|鹹蛋/.test(n)) {
    ...
    return (
      ...
      >
        <path
          d="M12 3.5C8.5 3.5 6 8.5 6 14a6 6 0 0 0 12 0c0-5.5-2.5-10.5-6-10.5z"
          fill="#fef9c3"
          stroke="#d97706"
        />
      </svg>
  ...
  switch (category) {
    ...
    case "mushroom":
      ...
      return (
        ...
        >
          <path
            d="M12 3a9 9 0 0 0-9 9c0 1 1 2 2 2h14c1 0 2-1 2-2a9 9 0 0 0-9-9z"
            fill="#fef08a"
            stroke="#854d0e"
          />
    ...
    case "leafy":
      ...
      return (
        ...
        >
          <path
            d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.5 19 2c0 4-1 9-5 13-1.5 1.5-2 3-3 5z"
            fill="#bbf7d0"
            stroke="#16a34a"
          />
    ...
    case "meat_seafood":
      ...
      return (
        ...
        >
          <path
            d="M6.5 12c.5-3.5 3-6.5 7.5-6.5 4 0 6 3 6 6.5s-2 6.5-6 6.5c-4.5 0-7-3-7.5-6.5z"
            fill="#fee2e2"
            stroke="#dc2626"
          />
    ...
    case "egg_dairy_bean":
      ...
      return (
        ...
        >
          <path
            d="M12 3C8 3 5 8.5 5 14a7 7 0 0 0 12 0c0-5.5-3-11-7-11z"
            fill="#fef9c3"
            stroke="#ca8a04"
          />
        </svg>
