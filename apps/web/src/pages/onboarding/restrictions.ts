...
export const restrictionQuickOptions: DietaryRestriction[] = [
  { id: "quick-peanut", label: "花生", kind: "allergy", ingredientKeys: ["花生", "花生醬"], isHardLimit: true },
  { id: "quick-tree-nuts", label: "堅果", kind: "allergy", ingredientKeys: ["堅果", "腰果", "杏仁", "核桃"], isHardLimit: true },
  { id: "quick-shellfish", label: "蝦蟹", kind: "allergy", ingredientKeys: ["蝦", "蟹", "甲殼類"], isHardLimit: true },
  { id: "quick-fish", label: "魚", kind: "allergy", ingredientKeys: ["魚"], isHardLimit: true },
  { id: "quick-egg", label: "蛋", kind: "allergy", ingredientKeys: ["蛋", "雞蛋"], isHardLimit: true },
  { id: "quick-milk", label: "牛奶", kind: "allergy", ingredientKeys: ["牛奶", "乳製品", "奶油", "起司"], isHardLimit: true },
  { id: "quick-gluten", label: "小麥／麩質", kind: "allergy", ingredientKeys: ["小麥", "麩質", "麵粉", "麵包", "麵條"], isHardLimit: true },
  { id: "quick-soy", label: "黃豆", kind: "allergy", ingredientKeys: ["黃豆", "大豆", "豆漿", "豆腐"], isHardLimit: true },
];
