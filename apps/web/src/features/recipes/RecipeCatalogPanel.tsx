...
export function PurchaseReminder({item,budget,allowRepeat,goalName,onClose,onUseInventory,onAdded}:{item:RecipeRecommendation;budget:number;allowRepeat:boolean;goalName?:string;onClose:()=>void;onUseInventory:()=>void;onAdded:()=>Promise<void>}){
